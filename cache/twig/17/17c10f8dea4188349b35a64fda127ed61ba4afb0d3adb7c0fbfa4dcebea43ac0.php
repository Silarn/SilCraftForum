...
class __TwigTemplate_eecb7b871d5f43c5fb91a6c2e679d17e6e8826b53f6f7cec1ace498b2ada80f1 extends Twig_Template
{
...
\t\t\t";
        ...
        $this->env->loadTemplate('@phpbbgallery_core/event/memberlist_view_user_statistics_after.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 117
        echo "\t\t</dl>
\t</div>
...
";
        ...
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('phpbbgallery_core', '__main__'));
        $this->env->loadTemplate('@phpbbgallery_core/event/memberlist_view_content_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        // line 139
        echo "
";
