...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'paybas.pbwow.core' => 'getPaybas_Pbwow_CoreService',
            'paybas.pbwow.listener' => 'getPaybas_Pbwow_ListenerService',
            ...
            'paybas.recenttopics.ucp_listener' => 'getPaybas_Recenttopics_UcpListenerService',
            'php_ini' => 'getPhpIniService',
            'phpbbgallery.acpcleanup.cleanup' => 'getPhpbbgallery_Acpcleanup_CleanupService',
            'phpbbgallery.core.album' => 'getPhpbbgallery_Core_AlbumService',
            'phpbbgallery.core.album.display' => 'getPhpbbgallery_Core_Album_DisplayService',
            'phpbbgallery.core.album.loader' => 'getPhpbbgallery_Core_Album_LoaderService',
            'phpbbgallery.core.auth' => 'getPhpbbgallery_Core_AuthService',
            'phpbbgallery.core.auth.level' => 'getPhpbbgallery_Core_Auth_LevelService',
            'phpbbgallery.core.cache' => 'getPhpbbgallery_Core_CacheService',
            'phpbbgallery.core.comment' => 'getPhpbbgallery_Core_CommentService',
            'phpbbgallery.core.config' => 'getPhpbbgallery_Core_ConfigService',
            'phpbbgallery.core.controller.album' => 'getPhpbbgallery_Core_Controller_AlbumService',
            'phpbbgallery.core.controller.comment' => 'getPhpbbgallery_Core_Controller_CommentService',
            'phpbbgallery.core.controller.file' => 'getPhpbbgallery_Core_Controller_FileService',
            'phpbbgallery.core.controller.image' => 'getPhpbbgallery_Core_Controller_ImageService',
            'phpbbgallery.core.controller.index' => 'getPhpbbgallery_Core_Controller_IndexService',
            'phpbbgallery.core.controller.moderate' => 'getPhpbbgallery_Core_Controller_ModerateService',
            'phpbbgallery.core.controller.search' => 'getPhpbbgallery_Core_Controller_SearchService',
            'phpbbgallery.core.controller.upload' => 'getPhpbbgallery_Core_Controller_UploadService',
            'phpbbgallery.core.file.tool' => 'getPhpbbgallery_Core_File_ToolService',
            'phpbbgallery.core.image' => 'getPhpbbgallery_Core_ImageService',
            'phpbbgallery.core.listener' => 'getPhpbbgallery_Core_ListenerService',
            'phpbbgallery.core.log' => 'getPhpbbgallery_Core_LogService',
            'phpbbgallery.core.misc' => 'getPhpbbgallery_Core_MiscService',
            'phpbbgallery.core.moderate' => 'getPhpbbgallery_Core_ModerateService',
            'phpbbgallery.core.notification.helper' => 'getPhpbbgallery_Core_Notification_HelperService',
            'phpbbgallery.core.notification.image_approved' => 'getPhpbbgallery_Core_Notification_ImageApprovedService',
            'phpbbgallery.core.notification.image_for_approval' => 'getPhpbbgallery_Core_Notification_ImageForApprovalService',
            'phpbbgallery.core.notification.new_comment' => 'getPhpbbgallery_Core_Notification_NewCommentService',
            'phpbbgallery.core.notification.new_image' => 'getPhpbbgallery_Core_Notification_NewImageService',
            'phpbbgallery.core.notification.new_report' => 'getPhpbbgallery_Core_Notification_NewReportService',
            'phpbbgallery.core.report' => 'getPhpbbgallery_Core_ReportService',
            'phpbbgallery.core.search' => 'getPhpbbgallery_Core_SearchService',
            'phpbbgallery.core.url' => 'getPhpbbgallery_Core_UrlService',
            'phpbbgallery.core.user' => 'getPhpbbgallery_Core_UserService',
            'phpbbgallery.exif.listener' => 'getPhpbbgallery_Exif_ListenerService',
            ...
            'vse.topicpreview.tool.remove_bbcodes' => 'getVse_Topicpreview_Tool_RemoveBbcodesService',
            'vse.topicpreview.tool.remove_bbcodes_legacy' => 'getVse_Topicpreview_Tool_RemoveBbcodesLegacyService',
            'vse.topicpreview.tool.remove_markup' => 'getVse_Topicpreview_Tool_RemoveMarkupService',
            'vse.topicpreview.tools.manager' => 'getVse_Topicpreview_Tools_ManagerService',
            'vse.topicpreview.tools_collection' => 'getVse_Topicpreview_ToolsCollectionService',
            'vse.topicpreview.trim' => 'getVse_Topicpreview_TrimService',
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('127.0.0.1', 'root', 'Rh3t@!y@_Jh!d@n!', 'silcraft_forum', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('dmzx.topicauthor.listener', 'dmzx\\topicauthor\\event\\listener');
        $instance->addSubscriberService('paybas.pbwow.listener', 'paybas\\pbwow\\event\\listener');
        $instance->addSubscriberService('paybas.recenttopics.listener', 'paybas\\recenttopics\\event\\listener');
        $instance->addSubscriberService('paybas.recenttopics.ucp_listener', 'paybas\\recenttopics\\event\\ucp_listener');
        $instance->addSubscriberService('phpbbgallery.core.listener', 'phpbbgallery\\core\\event\\main_listener');
        $instance->addSubscriberService('phpbbgallery.exif.listener', 'phpbbgallery\\exif\\event\\exif_listener');
    ...
    /**
     * Gets the 'dmzx.topicauthor.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \dmzx\topicauthor\event\listener A dmzx\topicauthor\event\listener instance.
     */
    protected function getDmzx_Topicauthor_ListenerService()
    {
        return $this->services['dmzx.topicauthor.listener'] = new \dmzx\topicauthor\event\listener();
    }
    ...
    protected function getNotification_TypeCollectionService()
    {
        ...
        $instance->add('phpbbgallery.core.notification.image_for_approval');
        $instance->add('phpbbgallery.core.notification.image_approved');
        $instance->add('phpbbgallery.core.notification.new_image');
        $instance->add('phpbbgallery.core.notification.new_comment');
        $instance->add('phpbbgallery.core.notification.new_report');
    ...
    /**
     * Gets the 'paybas.pbwow.core' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\pbwow\core\pbwow A paybas\pbwow\core\pbwow instance.
     */
    protected function getPaybas_Pbwow_CoreService()
    {
        return $this->services['paybas.pbwow.core'] = new \paybas\pbwow\core\pbwow($this->get('config'), $this->get('cache'), $this->get('dbal.conn'), $this->get('dbal.tools'), $this->get('dispatcher'), $this->get('ext.manager'), $this->get('profilefields.manager'), $this->get('template'), $this->get('user'), $this->get('path_helper'), './../', 'php', 'phpbb_pbwow3_config', 'phpbb_pbwow3_chars');
    }

    /**
     * Gets the 'paybas.pbwow.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\pbwow\event\listener A paybas\pbwow\event\listener instance.
     */
    protected function getPaybas_Pbwow_ListenerService()
    {
        return $this->services['paybas.pbwow.listener'] = new \paybas\pbwow\event\listener($this->get('paybas.pbwow.core'));
    }

    /**
     * Gets the 'paybas.recenttopics.functions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\recenttopics\core\recenttopics A paybas\recenttopics\core\recenttopics instance.
     */
    protected function getPaybas_Recenttopics_FunctionsService()
    {
        return $this->services['paybas.recenttopics.functions'] = new \paybas\recenttopics\core\recenttopics($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('content.visibility'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('pagination'), $this->get('request'), $this->get('template'), $this->get('user'), './../', 'php');
    }

    /**
     * Gets the 'paybas.recenttopics.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\recenttopics\event\listener A paybas\recenttopics\event\listener instance.
     */
    protected function getPaybas_Recenttopics_ListenerService()
    {
        return $this->services['paybas.recenttopics.listener'] = new \paybas\recenttopics\event\listener($this->get('paybas.recenttopics.functions'), $this->get('config'), $this->get('request'));
    }

    /**
     * Gets the 'paybas.recenttopics.ucp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \paybas\recenttopics\event\ucp_listener A paybas\recenttopics\event\ucp_listener instance.
     */
    protected function getPaybas_Recenttopics_UcpListenerService()
    {
        return $this->services['paybas.recenttopics.ucp_listener'] = new \paybas\recenttopics\event\ucp_listener($this->get('auth'), $this->get('config'), $this->get('request'), $this->get('template'), $this->get('user'));
    }
    ...
    /**
     * Gets the 'phpbbgallery.acpcleanup.cleanup' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\acpcleanup\cleanup A phpbbgallery\acpcleanup\cleanup instance.
     */
    protected function getPhpbbgallery_Acpcleanup_CleanupService()
    {
        return $this->services['phpbbgallery.acpcleanup.cleanup'] = new \phpbbgallery\acpcleanup\cleanup($this->get('dbal.conn'), $this->get('phpbbgallery.core.file.tool'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.comment'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.log'), 'phpbb_gallery_albums', 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.album' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\album\album A phpbbgallery\core\album\album instance.
     */
    protected function getPhpbbgallery_Core_AlbumService()
    {
        return $this->services['phpbbgallery.core.album'] = new \phpbbgallery\core\album\album($this->get('dbal.conn'), $this->get('user'), 'phpbb_gallery_albums', 'phpbb_gallery_watch', 'phpbb_gallery_contests');
    }

    /**
     * Gets the 'phpbbgallery.core.album.display' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\album\display A phpbbgallery\core\album\display instance.
     */
    protected function getPhpbbgallery_Core_Album_DisplayService()
    {
        return $this->services['phpbbgallery.core.album.display'] = new \phpbbgallery\core\album\display($this->get('auth'), $this->get('config'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('pagination'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.misc'), './../', 'php', 'phpbb_gallery_albums', 'phpbb_gallery_contests', 'phpbb_gallery_albums_track', 'phpbb_gallery_modscache');
    }

    /**
     * Gets the 'phpbbgallery.core.album.loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\album\loader A phpbbgallery\core\album\loader instance.
     */
    protected function getPhpbbgallery_Core_Album_LoaderService()
    {
        return $this->services['phpbbgallery.core.album.loader'] = new \phpbbgallery\core\album\loader($this->get('dbal.conn'), $this->get('user'), 'phpbb_gallery_albums');
    }

    /**
     * Gets the 'phpbbgallery.core.auth' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\auth\auth A phpbbgallery\core\auth\auth instance.
     */
    protected function getPhpbbgallery_Core_AuthService()
    {
        return $this->services['phpbbgallery.core.auth'] = new \phpbbgallery\core\auth\auth($this->get('phpbbgallery.core.cache'), $this->get('dbal.conn'), $this->get('phpbbgallery.core.user'), $this->get('user'), $this->get('auth'), 'phpbb_gallery_permissions', 'phpbb_gallery_roles', 'phpbb_gallery_users', 'phpbb_gallery_albums');
    }

    /**
     * Gets the 'phpbbgallery.core.auth.level' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\auth\level A phpbbgallery\core\auth\level instance.
     */
    protected function getPhpbbgallery_Core_Auth_LevelService()
    {
        return $this->services['phpbbgallery.core.auth.level'] = new \phpbbgallery\core\auth\level($this->get('phpbbgallery.core.auth'), $this->get('config'), $this->get('template'), $this->get('user'));
    }

    /**
     * Gets the 'phpbbgallery.core.cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\cache A phpbbgallery\core\cache instance.
     */
    protected function getPhpbbgallery_Core_CacheService()
    {
        return $this->services['phpbbgallery.core.cache'] = new \phpbbgallery\core\cache($this->get('cache'), $this->get('dbal.conn'), 'phpbb_gallery_albums', 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\comment A phpbbgallery\core\comment instance.
     */
    protected function getPhpbbgallery_Core_CommentService()
    {
        return $this->services['phpbbgallery.core.comment'] = new \phpbbgallery\core\comment($this->get('user'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.album'));
    }

    /**
     * Gets the 'phpbbgallery.core.config' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\config A phpbbgallery\core\config instance.
     */
    protected function getPhpbbgallery_Core_ConfigService()
    {
        return $this->services['phpbbgallery.core.config'] = new \phpbbgallery\core\config($this->get('config'));
    }

    /**
     * Gets the 'phpbbgallery.core.controller.album' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\album A phpbbgallery\core\controller\album instance.
     */
    protected function getPhpbbgallery_Core_Controller_AlbumService()
    {
        return $this->services['phpbbgallery.core.controller.album'] = new \phpbbgallery\core\controller\album($this->get('config'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('pagination'), $this->get('template'), $this->get('user'), $this->get('phpbbgallery.core.album.display'), $this->get('phpbbgallery.core.album.loader'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.auth.level'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.notification.helper'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.image'), $this->get('request'), 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.comment' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\comment A phpbbgallery\core\controller\comment instance.
     */
    protected function getPhpbbgallery_Core_Controller_CommentService()
    {
        return $this->services['phpbbgallery.core.controller.comment'] = new \phpbbgallery\core\controller\comment($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('template'), $this->get('request'), $this->get('controller.helper'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.album.loader'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.album.display'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.misc'), $this->get('phpbbgallery.core.comment'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.log'), $this->get('phpbbgallery.core.notification.helper'), 'phpbb_gallery_comments', './../', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\file A phpbbgallery\core\controller\file instance.
     */
    protected function getPhpbbgallery_Core_Controller_FileService()
    {
        return $this->services['phpbbgallery.core.controller.file'] = new \phpbbgallery\core\controller\file($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.file.tool'), $this->get('request'), './../files/phpbbgallery/core/source/', './../files/phpbbgallery/core/medium/', './../files/phpbbgallery/core/mini/', './../ext/phpbbgallery/core/images/watermark.png', 'phpbb_gallery_albums', 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\image A phpbbgallery\core\controller\image instance.
     */
    protected function getPhpbbgallery_Core_Controller_ImageService()
    {
        return $this->services['phpbbgallery.core.controller.image'] = new \phpbbgallery\core\controller\image($this->get('request'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('pagination'), $this->get('template'), $this->get('user'), $this->get('phpbbgallery.core.album.display'), $this->get('phpbbgallery.core.album.loader'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.auth.level'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.misc'), $this->get('phpbbgallery.core.comment'), $this->get('phpbbgallery.core.report'), $this->get('phpbbgallery.core.notification.helper'), $this->get('phpbbgallery.core.log'), 'phpbb_gallery_albums', 'phpbb_gallery_images', 'phpbb_gallery_users', 'phpbb_gallery_comments', './../', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.index' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\index A phpbbgallery\core\controller\index instance.
     */
    protected function getPhpbbgallery_Core_Controller_IndexService()
    {
        return $this->services['phpbbgallery.core.controller.index'] = new \phpbbgallery\core\controller\index($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), $this->get('phpbbgallery.core.album.display'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.search'), $this->get('pagination'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.image'), './../', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.moderate' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\moderate A phpbbgallery\core\controller\moderate instance.
     */
    protected function getPhpbbgallery_Core_Controller_ModerateService()
    {
        return $this->services['phpbbgallery.core.controller.moderate'] = new \phpbbgallery\core\controller\moderate($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), $this->get('phpbbgallery.core.album.display'), $this->get('phpbbgallery.core.moderate'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.misc'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.notification.helper'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.log'), $this->get('phpbbgallery.core.report'), $this->get('user_loader'), './../', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.search' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\search A phpbbgallery\core\controller\search instance.
     */
    protected function getPhpbbgallery_Core_Controller_SearchService()
    {
        return $this->services['phpbbgallery.core.controller.search'] = new \phpbbgallery\core\controller\search($this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('pagination'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), $this->get('phpbbgallery.core.album.display'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.search'), 'phpbb_gallery_images', 'phpbb_gallery_albums', 'phpbb_gallery_comments', './../', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.controller.upload' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\controller\upload A phpbbgallery\core\controller\upload instance.
     */
    protected function getPhpbbgallery_Core_Controller_UploadService()
    {
        return $this->services['phpbbgallery.core.controller.upload'] = new \phpbbgallery\core\controller\upload($this->get('request'), $this->get('dbal.conn'), $this->get('user'), $this->get('template'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.misc'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.album.display'), $this->get('controller.helper'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.image'), $this->get('phpbbgallery.core.notification.helper'), $this->get('phpbbgallery.core.url'), 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.file.tool' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\file\file A phpbbgallery\core\file\file instance.
     */
    protected function getPhpbbgallery_Core_File_ToolService()
    {
        return $this->services['phpbbgallery.core.file.tool'] = new \phpbbgallery\core\file\file(2);
    }

    /**
     * Gets the 'phpbbgallery.core.image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\image\image A phpbbgallery\core\image\image instance.
     */
    protected function getPhpbbgallery_Core_ImageService()
    {
        return $this->services['phpbbgallery.core.image'] = new \phpbbgallery\core\image\image($this->get('dbal.conn'), $this->get('user'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.config'), $this->get('controller.helper'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.log'), $this->get('phpbbgallery.core.notification.helper'), $this->get('phpbbgallery.core.report'), $this->get('phpbbgallery.core.cache'), $this->get('phpbbgallery.core.user'), $this->get('phpbbgallery.core.file.tool'), 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\event\main_listener A phpbbgallery\core\event\main_listener instance.
     */
    protected function getPhpbbgallery_Core_ListenerService()
    {
        return $this->services['phpbbgallery.core.listener'] = new \phpbbgallery\core\event\main_listener($this->get('controller.helper'), $this->get('template'), $this->get('user'), $this->get('phpbbgallery.core.search'), $this->get('phpbbgallery.core.config'), $this->get('dbal.conn'), 'phpbb_gallery_albums', 'phpbb_gallery_users', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.log' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\log A phpbbgallery\core\log instance.
     */
    protected function getPhpbbgallery_Core_LogService()
    {
        return $this->services['phpbbgallery.core.log'] = new \phpbbgallery\core\log($this->get('dbal.conn'), $this->get('user'), $this->get('user_loader'), $this->get('template'), $this->get('controller.helper'), $this->get('pagination'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.config'), 'phpbb_gallery_log');
    }

    /**
     * Gets the 'phpbbgallery.core.misc' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\misc A phpbbgallery\core\misc instance.
     */
    protected function getPhpbbgallery_Core_MiscService()
    {
        return $this->services['phpbbgallery.core.misc'] = new \phpbbgallery\core\misc();
    }

    /**
     * Gets the 'phpbbgallery.core.moderate' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\moderate A phpbbgallery\core\moderate instance.
     */
    protected function getPhpbbgallery_Core_ModerateService()
    {
        return $this->services['phpbbgallery.core.moderate'] = new \phpbbgallery\core\moderate($this->get('dbal.conn'), $this->get('template'), $this->get('controller.helper'), $this->get('user'), $this->get('user_loader'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.auth'), $this->get('pagination'), $this->get('phpbbgallery.core.config'), 'phpbb_gallery_images');
    }

    /**
     * Gets the 'phpbbgallery.core.notification.helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\notification\helper A phpbbgallery\core\notification\helper instance.
     */
    protected function getPhpbbgallery_Core_Notification_HelperService()
    {
        return $this->services['phpbbgallery.core.notification.helper'] = new \phpbbgallery\core\notification\helper($this->get('config'), $this->get('dbal.conn'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.album.loader'), $this->get('controller.helper'), $this->get('phpbbgallery.core.url'), $this, './../', 'php', 'phpbb_gallery_watch');
    }

    /**
     * Gets the 'phpbbgallery.core.notification.image_approved' service.
     *
     * @return \phpbbgallery\core\notification\events\phpbbgallery_image_approved A phpbbgallery\core\notification\events\phpbbgallery_image_approved instance.
     */
    protected function getPhpbbgallery_Core_Notification_ImageApprovedService()
    {
        return new \phpbbgallery\core\notification\events\phpbbgallery_image_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'phpbbgallery.core.notification.image_for_approval' service.
     *
     * @return \phpbbgallery\core\notification\events\phpbbgallery_image_for_approval A phpbbgallery\core\notification\events\phpbbgallery_image_for_approval instance.
     */
    protected function getPhpbbgallery_Core_Notification_ImageForApprovalService()
    {
        return new \phpbbgallery\core\notification\events\phpbbgallery_image_for_approval($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'phpbbgallery.core.notification.new_comment' service.
     *
     * @return \phpbbgallery\core\notification\events\phpbbgallery_new_comment A phpbbgallery\core\notification\events\phpbbgallery_new_comment instance.
     */
    protected function getPhpbbgallery_Core_Notification_NewCommentService()
    {
        return new \phpbbgallery\core\notification\events\phpbbgallery_new_comment($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'phpbbgallery.core.notification.new_image' service.
     *
     * @return \phpbbgallery\core\notification\events\phpbbgallery_new_image A phpbbgallery\core\notification\events\phpbbgallery_new_image instance.
     */
    protected function getPhpbbgallery_Core_Notification_NewImageService()
    {
        return new \phpbbgallery\core\notification\events\phpbbgallery_new_image($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'phpbbgallery.core.notification.new_report' service.
     *
     * @return \phpbbgallery\core\notification\events\phpbbgallery_new_report A phpbbgallery\core\notification\events\phpbbgallery_new_report instance.
     */
    protected function getPhpbbgallery_Core_Notification_NewReportService()
    {
        return new \phpbbgallery\core\notification\events\phpbbgallery_new_report($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), $this->get('controller.helper'), './../', 'php', 'phpbb_notification_types', 'phpbb_notifications', 'phpbb_user_notifications');
    }

    /**
     * Gets the 'phpbbgallery.core.report' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\report A phpbbgallery\core\report instance.
     */
    protected function getPhpbbgallery_Core_ReportService()
    {
        return $this->services['phpbbgallery.core.report'] = new \phpbbgallery\core\report($this->get('phpbbgallery.core.log'), $this->get('phpbbgallery.core.auth'), $this->get('user'), $this->get('dbal.conn'), $this->get('user_loader'), $this->get('phpbbgallery.core.album'), $this->get('template'), $this->get('controller.helper'), $this->get('phpbbgallery.core.config'), $this->get('pagination'), $this->get('phpbbgallery.core.notification.helper'), 'phpbb_gallery_images', 'phpbb_gallery_reports');
    }

    /**
     * Gets the 'phpbbgallery.core.search' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\search A phpbbgallery\core\search instance.
     */
    protected function getPhpbbgallery_Core_SearchService()
    {
        return $this->services['phpbbgallery.core.search'] = new \phpbbgallery\core\search($this->get('dbal.conn'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.album'), $this->get('phpbbgallery.core.image'), $this->get('pagination'), $this->get('user_loader'), 'phpbb_gallery_images', 'phpbb_gallery_albums', 'phpbb_gallery_comments');
    }

    /**
     * Gets the 'phpbbgallery.core.url' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\url A phpbbgallery\core\url instance.
     */
    protected function getPhpbbgallery_Core_UrlService()
    {
        return $this->services['phpbbgallery.core.url'] = new \phpbbgallery\core\url($this->get('template'), $this->get('request'), $this->get('config'), './../', 'php');
    }

    /**
     * Gets the 'phpbbgallery.core.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\core\user A phpbbgallery\core\user instance.
     */
    protected function getPhpbbgallery_Core_UserService()
    {
        return $this->services['phpbbgallery.core.user'] = new \phpbbgallery\core\user($this->get('dbal.conn'), $this->get('dispatcher'), 'phpbb_gallery_users');
    }

    /**
     * Gets the 'phpbbgallery.exif.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbbgallery\exif\event\exif_listener A phpbbgallery\exif\event\exif_listener instance.
     */
    protected function getPhpbbgallery_Exif_ListenerService()
    {
        return $this->services['phpbbgallery.exif.listener'] = new \phpbbgallery\exif\event\exif_listener($this->get('user'), $this->get('phpbbgallery.core.config'), $this->get('phpbbgallery.core.auth'), $this->get('phpbbgallery.core.url'), $this->get('phpbbgallery.core.user'));
    }
    ...
    {
        return $this->services['vse.passwordstrength.listener'] = new \vse\passwordstrength\event\listener($this->get('config'), $this->get('template'), $this->get('user'));
    }
    ...
    {
        return $this->services['vse.topicpreview.display'] = new \vse\topicpreview\core\display($this->get('config'), $this->get('dispatcher'), $this->get('template'), $this->get('vse.topicpreview.trim'), $this->get('user'), './../');
    }
    ...
    /**
     * Gets the 'vse.topicpreview.tool.remove_bbcodes' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\tools\remove_bbcodes A vse\topicpreview\core\trim\tools\remove_bbcodes instance.
     */
    protected function getVse_Topicpreview_Tool_RemoveBbcodesService()
    {
        $this->services['vse.topicpreview.tool.remove_bbcodes'] = $instance = new \vse\topicpreview\core\trim\tools\remove_bbcodes($this->get('config'), $this->get('vse.topicpreview.tool.remove_bbcodes_legacy'), NULL);

        $instance->set_name('remove_bbcodes');

        return $instance;
    }

    /**
     * Gets the 'vse.topicpreview.tool.remove_bbcodes_legacy' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\tools\remove_bbcodes_legacy A vse\topicpreview\core\trim\tools\remove_bbcodes_legacy instance.
     */
    protected function getVse_Topicpreview_Tool_RemoveBbcodesLegacyService()
    {
        $this->services['vse.topicpreview.tool.remove_bbcodes_legacy'] = $instance = new \vse\topicpreview\core\trim\tools\remove_bbcodes_legacy($this->get('config'));

        $instance->set_name('remove_bbcodes_legacy');

        return $instance;
    }

    /**
     * Gets the 'vse.topicpreview.tool.remove_markup' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\tools\remove_markup A vse\topicpreview\core\trim\tools\remove_markup instance.
     */
    protected function getVse_Topicpreview_Tool_RemoveMarkupService()
    {
        $this->services['vse.topicpreview.tool.remove_markup'] = $instance = new \vse\topicpreview\core\trim\tools\remove_markup();

        $instance->set_name('remove_markup');

        return $instance;
    }

    /**
     * Gets the 'vse.topicpreview.tools.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\manager A vse\topicpreview\core\trim\manager instance.
     */
    protected function getVse_Topicpreview_Tools_ManagerService()
    {
        return $this->services['vse.topicpreview.tools.manager'] = new \vse\topicpreview\core\trim\manager($this->get('vse.topicpreview.tools_collection'));
    }

    /**
     * Gets the 'vse.topicpreview.tools_collection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \phpbb\di\service_collection A phpbb\di\service_collection instance.
     */
    protected function getVse_Topicpreview_ToolsCollectionService()
    {
        $this->services['vse.topicpreview.tools_collection'] = $instance = new \phpbb\di\service_collection($this);

        $instance->add('vse.topicpreview.tool.remove_bbcodes');
        $instance->add('vse.topicpreview.tool.remove_bbcodes_legacy');
        $instance->add('vse.topicpreview.tool.remove_markup');

        return $instance;
    }

    /**
     * Gets the 'vse.topicpreview.trim' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \vse\topicpreview\core\trim\trim A vse\topicpreview\core\trim\trim instance.
     */
    protected function getVse_Topicpreview_TrimService()
    {
        return $this->services['vse.topicpreview.trim'] = new \vse\topicpreview\core\trim\trim($this->get('vse.topicpreview.tools.manager'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.pbwow3_config' => 'phpbb_pbwow3_config',
            'tables.pbwow3_chars' => 'phpbb_pbwow3_chars',
            'tables.phpbbgallery.albums' => 'phpbb_gallery_albums',
            'tables.phpbbgallery.images' => 'phpbb_gallery_images',
            'phpbbgallery.core.file.source' => './../files/phpbbgallery/core/source/',
            'phpbbgallery.core.file.medium' => './../files/phpbbgallery/core/medium/',
            'phpbbgallery.core.file.mini' => './../files/phpbbgallery/core/mini/',
            'phpbbgallery.core.file.watermark' => './../ext/phpbbgallery/core/images/watermark.png',
            'tables.phpbbgallery.contests' => 'phpbb_gallery_contests',
            'tables.phpbbgallery.moderators' => 'phpbb_gallery_modscache',
            'tables.phpbbgallery.permissions' => 'phpbb_gallery_permissions',
            'tables.phpbbgallery.roles' => 'phpbb_gallery_roles',
            'tables.phpbbgallery.tracking' => 'phpbb_gallery_albums_track',
            'tables.phpbbgallery.users' => 'phpbb_gallery_users',
            'tables.phpbbgallery.comments' => 'phpbb_gallery_comments',
            'tables.phpbbgallery.reports' => 'phpbb_gallery_reports',
            'tables.phpbbgallery.log' => 'phpbb_gallery_log',
            'tables.phpbbgallery.watch' => 'phpbb_gallery_watch',
            ...
            'dbal.dbuser' => 'root',
            'dbal.dbpasswd' => 'Rh3t@!y@_Jh!d@n!',
            'dbal.dbname' => 'silcraft_forum',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
